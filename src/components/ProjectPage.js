...
const sliderImages = {
  rpt: [
    { url: require("../images/reporting_line.png") },
    { url: require("../images/reporting_ticket.png") },
    { url: require("../images/reporting_comparison.png") },
    { url: require("../images/reporting_builder.png") }
  ],
  ci: [
    { url: require("../images/list_view_desktop.jpg") },
    { url: require("../images/master_calendar_desktop.jpg") },
    { url: require("../images/show_details_desktop.jpg") },
    { url: require("../images/cart_desktop.jpg") }
  ],
  adm: [
    { url: require("../images/household_members.png") },
    { url: require("../images/household_addmember.png") },
    { url: require("../images/household_donations.png") },
    { url: require("../images/household_orderhistory.png") }
  ],
  grok: [
    { url: require("../images/grok_home.png") },
    { url: require("../images/grok_topic_page.png") },
    { url: require("../images/grok_learning_plan.png") },
    { url: require("../images/grok_learning_list.png") }
  ],
  new2nyc: [{ url: require("../images/new2nyc_home.jpg") }]
};
...
const ProjectPageCI = () => {
  let desc =
    "The OvationTix Consumer Interface provided clients a platform for their patrons to purchase tickets. \n" +
  ...
  return (
    <div className='projectPageContainer'>
      ...
      <div className='secondPage'>
        ...
        >
          <Images desktop={"cart_desktop.jpg"} mobile={"cart_mobile.jpg"} />
...
const ProjectPageRPT = () => {
  let desc =
    "The OvationTix Reporting Dashboard was built to provide clients with an amazing visual representation \n" +
  ...
  return (
    <div className='projectPageContainer'>
      <div className='firstPage'>
        ...
        <div className='rightContent'>
          <Images desktop={"reporting_line.png"} mobile={null} />
        </div>
        <div className='simpleSlider'>
          <SimpleImageSlider
            width={300}
            height={200}
            images={sliderImages.rpt}
            showBullets={false}
          />
        </div>
      </div>
      <div className='secondPage'>
        ...
        >
          <Images desktop={"reporting_ticket.png"} mobile={null} />
        ...
        >
          ...
          <Images desktop={"reporting_comparison.png"} mobile={null} />
        </div>
        <div
          className='imageContainer'
          style={{
        ...
        >
          <Images desktop={"reporting_builder.png"} mobile={null} />
...
const ProjectPageADM = () => {
  let desc =
    "The OvationTix Admin Interface is a complex program with specific features design to address issues in the \n" +
  ...
  return (
    <div className='projectPageContainer'>
      <div className='firstPage'>
        ...
        <div className='rightContent'>
          <Images desktop={"household_members.png"} mobile={null} />
        </div>
        <div className='simpleSlider'>
          <SimpleImageSlider
            width={300}
            height={200}
            images={sliderImages.adm}
            showBullets={false}
          />
        </div>
      </div>
      <div className='secondPage'>
        ...
        >
          <Images desktop={"household_addmember.png"} mobile={null} />
        ...
        >
          ...
          <Images desktop={"household_donations.png"} mobile={null} />
        </div>
        <div
          className='imageContainer'
          style={{
        ...
        >
          <Images desktop={"household_orderhistory.png"} mobile={null} />
...
const ProjectPageGROK = () => {
  let desc =
    "Grok was created for the sole purpose of learning. It is a database comprised of articles and topics that \n" +
  ...
  return (
    <div className='projectPageContainer'>
      <div className='firstPage'>
        ...
        <div className='rightContent'>
          <Images desktop={"grok_home.png"} mobile={null} />
        </div>
        <div className='simpleSlider'>
          <SimpleImageSlider
            width={300}
            height={200}
            images={sliderImages.grok}
            showBullets={false}
          />
        </div>
      </div>
      <div className='secondPage'>
        ...
        >
          <Images desktop={"grok_topic_page.png"} mobile={null} />
        ...
        >
          ...
          <Images desktop={"grok_learning_plan.png"} mobile={null} />
        </div>
        <div
          className='imageContainer'
          style={{
        ...
        >
          <Images desktop={"grok_learning_list.png"} mobile={null} />
...
const ProjectPageNEW = () => {
  let desc =
    "new2nyc is a mobile application created during a 24-hour hackathon for immigrants in New York. It was built to \n" +
