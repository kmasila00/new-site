...
const About = () => {
  let description = "I first started coding as a sophomore in high school. I started with Visual Basic and Java " +
    ...
    let description2 = "After graduating, I became an EMT and pursed that as a career. Of course I was never able to get rid of the " +
    ...
    let description3 = "I have since worked on a few freelance projects and I currently work as a Front End Developer for a company" +
